...
ANSELBbits.ANSB0 = 1;    //extreme droite
ANSELCbits.ANSC0 = 1;   //droit
ANSELCbits.ANSC11 = 1;  //centre
ANSELEbits.ANSE14 = 1;  //extreme gauche
ANSELGbits.ANSG9 = 1;   //gauche



//H pour les ANA supérieur à 15 et L pour les ANA <= à 15
AD1CSSLbits.CSS2 = 1;// Enable ANA2 for scan
AD1CSSLbits.CSS6=1; // Enable ANA6 for scan
AD1CSSLbits.CSS11=1; // Enable ANA11 for scan
AD1CSSLbits.CSS14=1; // Enable ANA9 for scan
AD1CSSHbits.CSS16=1; // Enable ANA16 for scan
...
ADCResult[1] = ADC1BUF1;// Read the AN-scan input 1 conversion result
